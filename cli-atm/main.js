...
async function welcome() {
    console.log(chalk.rgb(21, 17, 245)(`
                  ATM
    ...
    const answer = await inquirer.prompt([
        {
            name: "main",
            type: "list",
            message: chalk.blue(`Select anyone (If you're new here, please take a moment to create an account.)`),
...
async function correctPin() {
    ...
    if (answer.option === withdraw) {
        ...
        // console.log(amount, typeof amount)
        let remainingAmount = initialAmount - amount;
        if (res) {
