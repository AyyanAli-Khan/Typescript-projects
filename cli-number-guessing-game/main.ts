...
async function solo_game() {
  ...
  console.log(
    chalk.rgb(174, 78, 212).bold("you have 5 chances to guess the number\n")
  );
  ...
  const again1 = await inquirer.prompt([
    {
      message: chalk.blueBright(
        "want to play again or exit to main menu ?(a/m) :"
      ),
      type: "string",
      name: "choise",
    },
...
async function twoPlayerGame() {
  ...
  console.log(
    chalk
      .rgb(83, 235, 56)
      .bold(
        "Are you ready to test your guessing skills? Let the games begin!\n"
      )
  );
    ...
    if (randomNumber === guessedNumber.player1Num) {
      console.log(
        chalk
          .rgb(242, 228, 104)
          .bold(
            `congratulations ${player.player1} you guessed the correct number!\n`
          )
      );
      console.log(
        chalk
          .rgb(230, 125, 96)
          .bold(
            `The winner of this game is ${chalk
              .rgb(242, 83, 39)
              .bold(player.player1)} `
          )
      );
      ...
      console.log(
        chalk.redBright(
          `Oops wronge guess ${player.player1} try other numbers\n`
        )
      );
    }
    console.log(
    ...
    if (randomNumber === guessedNumber2.player2Num) {
      console.log(
        chalk
          .rgb(242, 228, 104)
          .bold(
            `congratulations ${player.player2} you guessed the correct number!\n`
          )
      );
      console.log(
        chalk
...
async function howtoplay() {
  ...
  if (reply.decision == option2) {
    console.log(
      chalk.rgb(91, 153, 194).bold(`Title: Two-Player Number Guessing Game
